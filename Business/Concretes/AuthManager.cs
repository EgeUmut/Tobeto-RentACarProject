...
public class AuthManager : IAuthService
{
    ...
    Task<IDataResult<AccessToken>> IAuthService.Login(UserForLoginDto userForLoginDto)
    {
        throw new NotImplementedException();
    }

    Task<IDataResult<AccessToken>> IAuthService.CreateAccessToken(User user)
    {
        throw new NotImplementedException();
    }

    Task<IDataResult<AccessToken>> IAuthService.Register(UserForRegisterDto userForRegisterDto)
    {
        throw new NotImplementedException();
    }
}
